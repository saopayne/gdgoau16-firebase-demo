package com.tracchis.saopayne.gdgoau_todo.activities;
...
import com.tracchis.saopayne.gdgoau_todo.adapters.TasksListAdapter;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private TasksListAdapter recyclerViewAdapter;
        ...
        addTaskButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(enteredTask)){
                    Toast.makeText(HomeActivity.this, "You must enter a task first", Toast.LENGTH_LONG).show();
                    return;
                }
                if(enteredTask.length() < 6){
                    Toast.makeText(HomeActivity.this, "Task count must be more than 6", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    private void getAllTask(DataSnapshot dataSnapshot){
        for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
            ...
            recyclerViewAdapter = new TasksListAdapter(HomeActivity.this, allTask);
